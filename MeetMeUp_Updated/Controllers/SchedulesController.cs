...
namespace MeetMeUp_Updated.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ScheduleID,ApplicationUserID,Occupation,Day,StartTime,EndTime")] Schedule schedule)
        {
            ...
            {
                schedule.ApplicationUserID = User.Identity.GetUserId();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ScheduleID,ApplicationUserID,Occupation,Day,StartTime,EndTime")] Schedule schedule)
        {
            if (ModelState.IsValid)
            {
